...
namespace AuthorizeNet {
    ...
    public class GatewayResponse : AuthorizeNet.IGatewayResponse {
        ...
        //A note about these parsers - a generic parse routine can be used
        //however costs a bit more in terms of overhead
        //try/cast works well for confined primitives - and we only have 3 possibilites for the return here... int, decimal, and string
        ...
        decimal ParseDecimal(int index) {
            decimal result = 0;
            if (RawResponse.Length > index)
        ...
        string ParseResponse(int index) {
            var result = "";
            if (RawResponse.Length > index) {
